            ...
            <div className="relative bg-white/[0.02] border border-white/[0.06] rounded-2xl overflow-hidden">
                ...
                <div className="px-6 md:px-8 py-7 border-b border-white/[0.06]">
                    <div className="flex items-center gap-4">
                        <div className="h-12 w-12 bg-emerald-500/10 rounded-xl flex items-center justify-center border border-emerald-500/20 shadow-lg shadow-emerald-500/10">
                            <ActivitySquare className="h-6 w-6 text-emerald-400" />
                        </div>
                        <div>
                ...
                {accesses.length === 0 ? (
                    <div className="flex flex-col items-center justify-center py-20 text-zinc-600">
                        ...
                        <p className="text-xs mt-1 text-zinc-700">Envie o link para seus clientes e os acessos aparecerão aqui!</p>
                    </div>
                ) : (
                        ...
                        <table className="w-full text-sm text-left">
                            <thead>
                                <tr className="border-b border-white/[0.04]">
                                    <th className="px-6 py-4 text-[10px] font-bold uppercase tracking-[0.2em] text-zinc-600">Galeria / Título</th>
                                    <th className="px-6 py-4 text-[10px] font-bold uppercase tracking-[0.2em] text-zinc-600">Data e Hora</th>
                                    <th className="px-6 py-4 text-[10px] font-bold uppercase tracking-[0.2em] text-zinc-600">IP / Identificador</th>
                                    <th className="px-6 py-4 text-[10px] font-bold uppercase tracking-[0.2em] text-zinc-600">Cliente (WhatsApp)</th>
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-white/[0.04]">
                                {accesses.map((access) => (
                                    <tr key={access.id} className="hover:bg-white/[0.02] transition-colors">
                                        ...
                                        <td className="px-6 py-4">
                                            {access.whatsapp ? (
                                                ...
                                                <span className="text-zinc-700 italic text-xs">Anônimo</span>
                                            )}
                                        </td>
                                    </tr>
                                ))}
